...
def enforce_usage_limit(feature: str, amount: int = 1):
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            # Atomic check & consume to avoid race condition
            can_use, msg = SubscriptionService.consume_feature_atomic(user_id, feature, amount)
            ...
            try:
                ...
                # Revert the consumption if the actual function failed (Davranışı korumak için)
